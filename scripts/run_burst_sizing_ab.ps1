...
$log = "logs\burst_sizing_ab_$(Get-Date -Format 'yyyyMMdd_HHmmss').log"

Add-Content $log "===== Burst-sizing A/B (read-only) : $(Get-Date -Format o) ====="
cmd /c "`"$py`" scripts/analyze_burst_sizing_ab.py >> `"$log`" 2>&1"
